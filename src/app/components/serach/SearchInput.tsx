...
const SearchInput = () => {
  ...
  return (
    <div className='bg-white flex items-center rounded-lg px-4 pr-2 relative' >
          <input type='text' placeholder='Ask a question' className='py-3 text-black bg-transparent outline-none ring-0 w-full pt-[17px]' 
          ...
          <div className={`${openSearchFilter ? 'bottom-auto py-4' : 'h-0 bottom-0' } px-4 transition-all duration-150 ease-linear overflow-hidden absolute w-full left-0 bg-white top-[45px] rounded-br-lg shadow-xl text-black rounded-bl-lg z-10`}>
              {/* popular topics */}
              <ul className='py-3'>
